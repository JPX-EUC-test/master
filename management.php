...
echo '<a href="./management.php' . '?base=' . date('Y-m-d', ($_GET['base'] ? strtotime($_GET['base']) : time()) - 86400) . '">前日</a>&nbsp;&nbsp;';

echo '<a href="./management.php' . '">最新</a>&nbsp;&nbsp;';

echo '<a href="./management.php' . '?base=' . date('Y-m-d', ($_GET['base'] ? strtotime($_GET['base']) : time()) + 86400) . '">翌日</a><br /><br />';

echo '<a href="./management_export.php' . ($_GET['base'] ? '?base=' . $_GET['base'] : NULL) . '">ダウンロード</a><br /><br />';
...
foreach($buffer as $code => $data)
{
  ...
  {
    echo endcode_subtraction($code);
    echo '</td><td>';
    echo $members[$prev_person]['member_code'];
    echo '</td><td>';
    echo $prev_person;
    echo '</td><td>';
    echo $members[$prev_person]['manager_code'];
    echo '</td><td>';
    echo $members[$prev_person]['manager_name'];
    echo '</td></tr>';
